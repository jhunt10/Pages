...
#
#var attack_direction:AttackHandler.AttackDirection
#var defender_has_cover:bool
#var is_aoe:bool:
	#get: return attack_direction == AttackHandler.AttackDirection.AOE
#
#var is_hit:bool
#var is_evade:bool
#var is_crit:bool
...
#func _init( attacking_actor:BaseActor, 
			...
			#direction_of_attack:AttackHandler.AttackDirection, 
...
#
#func roll_for_hit():
	#if attack_direction == AttackHandler.AttackDirection.Front:
		#if LOGGING: print("Attacking from FRONT")
	#if attack_direction == AttackHandler.AttackDirection.Flank:
		#if LOGGING: print("Attacking from Flank")
	#if attack_direction == AttackHandler.AttackDirection.Back:
		#if LOGGING: print("Attacking from Back")
	#if attack_direction == AttackHandler.AttackDirection.AOE:
	...
	#if is_hit and attack_direction != AttackHandler.AttackDirection.AOE:
